               ...
               :    }
               :
               :    pub fn with_log(original_input: &'i str, log_syntax_violation: Option<&Fn(&'static str)>) /* url::parser::Input::with_log::he630f4f7133c02bd total:      2 5.3e-05 */
               :                    -> Self {
               ...
               :    }
               :
               :    pub fn parse_host(mut input: Input, scheme_type: SchemeType) /* url::parser::Parser::parse_host::heccda7d543f19f84 total:      1 2.6e-05 */
               ...
               :            match c {
     1 2.6e-05 :                ':' if !inside_square_brackets => break,
               :                '\\' if scheme_type.is_special() => break,
               :                '/' | '?' | '#' => break,
               :                '\t' | '\n' | '\r' => {
               ...
               :    }
               :
               :    pub fn parse_path_start<'i>(&mut self, scheme_type: SchemeType, has_host: &mut bool, /* url::parser::Parser::parse_path_start::h89c23a36d1df5d23 total:      1 2.6e-05 */
               :                            mut input: Input<'i>)
               :                            -> Input<'i> {
               :        // Path start state
               ...
               :    }
               :
     2 5.3e-05 :    pub fn parse_path<'i>(&mut self, scheme_type: SchemeType, has_host: &mut bool, /* url::parser::Parser::parse_path::h86cc83584da1ae51 total:      3 7.9e-05 */
               ...
               :                        } else {
     1 2.6e-05 :                            self.serialization.extend(utf8_percent_encode(
               ...
               :    }
               :
     1 2.6e-05 :    fn check_url_code_point(&self, c: char, input: &Input) { /* url::parser::Parser::check_url_code_point::hd54b561c4013e309 total:      2 5.3e-05 */
               :        if let Some(log) = self.log_syntax_violation {
               :            if c == '%' {
     ...
     1 2.6e-05 :    }
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/url-1.5.1/src/parser.rs"
 * 
 *      6 1.6e-04
 */
