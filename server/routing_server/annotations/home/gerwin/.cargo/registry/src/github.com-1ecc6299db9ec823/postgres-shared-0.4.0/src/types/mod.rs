               ...
               :macro_rules! accepts {
               :    ($($expected:pat),+) => (
     7 1.8e-04 :        fn accepts(ty: &$crate::types::Type) -> bool { /* _$LT$i32$u20$as$u20$postgres_shared..types..FromSql$GT$::accepts::hdc34f03e61460ceb     26 6.9e-04, _$LT$f32$u20$as$u20$postgres_shared..types..FromSql$GT$::accepts::h625e40603c261bfb      5 1.3e-04, _$LT$f64$u20$as$u20$postgres_shared..types..FromSql$GT$::accepts::hec18764317e9dd43      6 1.6e-04, total:     37 9.8e-04 */
               :            match *ty {
               :                $($expected)|+ => true,
               :                _ => false
               :            }
    12 3.2e-04 :        }
     ...
     6 1.6e-04 :    pub fn kind(&self) -> &Kind { /* postgres_shared::types::Type::kind::hc068789d067e7327 total:     20 5.3e-04 */
               :        self.0.kind()
     1 2.6e-05 :    }
               :
     ...
     7 1.8e-04 :        match raw {
    17 4.5e-04 :            Some(raw) => Self::from_sql(ty, raw),
     ...
     1 2.6e-05 :        <T as FromSql>::from_sql(ty, raw).map(Some)
               :    }
               :
               ...
               :
               :    fn accepts(ty: &Type) -> bool {
     1 2.6e-05 :        <T as FromSql>::accepts(ty)
               :    }
               :}
               :
     ...
     2 5.3e-05 :            Kind::Array(ref member) => member,
               :            _ => panic!("expected array type"),
               :        };
               :
     2 5.3e-05 :        let array = types::array_from_sql(raw)?;
     ...
     1 2.6e-05 :        array
               ...
               :
               :    fn accepts(ty: &Type) -> bool {
     3 7.9e-05 :        match *ty.kind() {
     2 5.3e-05 :            Kind::Array(ref inner) => T::accepts(inner),
               :            _ => false,
               :        }
               :    }
               :}
     ...
     1 2.6e-05 :    fn from_sql(_: &Type, raw: &[u8]) -> Result<String, Box<Error + Sync + Send>> { /* _$LT$collections..string..String$u20$as$u20$postgres_shared..types..FromSql$GT$::from_sql::he5b3746f45dae725 total:     15 4.0e-04 */
               :        types::text_from_sql(raw).map(|b| b.to_owned())
     2 5.3e-05 :    }
               :
               :    fn accepts(ty: &Type) -> bool { /* _$LT$collections..string..String$u20$as$u20$postgres_shared..types..FromSql$GT$::accepts::h81289e67a5f876d3 total:      7 1.8e-04 */
               :        match *ty {
     3 7.9e-05 :            VARCHAR | TEXT | BPCHAR | NAME | UNKNOWN => true,
     ...
     4 1.1e-04 :    }
               ...
               :        impl FromSql for $t {
    29 7.7e-04 :            fn from_sql(_: &Type, /* _$LT$i32$u20$as$u20$postgres_shared..types..FromSql$GT$::from_sql::h2472df734735c131     54  0.0014, _$LT$f32$u20$as$u20$postgres_shared..types..FromSql$GT$::from_sql::hd178ceeac2a66f09     30 7.9e-04, _$LT$f64$u20$as$u20$postgres_shared..types..FromSql$GT$::from_sql::hb93c93f7d377d716     12 3.2e-04, total:     96  0.0025 */
               :                        raw: &[u8])
    ...
    13 3.4e-04 :simple_from!(i32, int4_from_sql, INT4);
     ...
     5 1.3e-04 :simple_from!(f64, float8_from_sql, FLOAT8);
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/postgres-shared-0.4.0/src/types/mod.rs"
 * 
 *    132  0.0035
 */
