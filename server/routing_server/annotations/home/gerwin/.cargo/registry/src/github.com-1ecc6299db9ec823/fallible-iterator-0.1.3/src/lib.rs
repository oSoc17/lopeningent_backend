               ...
               :              Self: Sized
               :    {
     8 2.1e-04 :        T::from_fallible_iterator(self)
               :    }
               :
               ...
               :    #[inline]
     2 5.3e-05 :    fn from_fallible_iterator<I>(mut it: I) -> Result<Vec<T>, I::Error>
               :        where I: FallibleIterator<Item = T>
               :    {
...
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/fallible-iterator-0.1.3/src/lib.rs"
 * 
 *     12 3.2e-04
 */
