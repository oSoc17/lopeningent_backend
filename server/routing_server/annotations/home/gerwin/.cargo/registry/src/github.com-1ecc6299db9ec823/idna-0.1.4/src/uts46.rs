     ...
     1 2.6e-05 :        Mapping::Valid => output.push(codepoint),
               :        Mapping::Ignored => {},
               ...
               :fn validate(label: &str, is_bidi_domain: bool, flags: Flags, errors: &mut Vec<Error>) { /* idna::uts46::validate::h16603606fa4633cf total:      2 5.3e-05 */
               ...
               :fn processing(domain: &str, flags: Flags, errors: &mut Vec<Error>) -> String { /* idna::uts46::processing::h9dc005c3a8851a91 total:      4 1.1e-04 */
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/idna-0.1.4/src/uts46.rs"
 * 
 *      1 2.6e-05
 */
