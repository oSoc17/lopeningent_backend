               ...
               :    /// of `rsl` as a seed, otherwise construct one algorithmically (not
               :    /// randomly).
     1 2.6e-05 :    fn init(&mut self, use_rsl: bool) { /* rand::isaac::Isaac64Rng::init::h847c6ed20c532ea4 total:      2 5.3e-05 */
               :        macro_rules! init {
               :            ($var:ident) => (
               ...
               :
               :    /// Refills the output buffer (`self.rsl`)
               :    fn isaac64(&mut self) { /* rand::isaac::Isaac64Rng::isaac64::h1cff033d87b024e9 total:     23 6.1e-04 */
               :        self.c = self.c + w(1);
               :        // abbreviations
               :        let mut a = self.a;
               :        let mut b = self.b + self.c;
               ...
               :                }
               :
     2 5.3e-05 :                rngstepp!(0, 21);
     6 1.6e-04 :                rngstepn!(1, 5);
     4 1.1e-04 :                rngstepp!(2, 12);
     1 2.6e-05 :                rngstepn!(3, 33);
               :            }
               :        }
               :
               :        self.a = a;
     ...
     2 5.3e-05 :        self.rsl[(self.cnt % RAND_SIZE_64) as usize].0
               :    }
               :}
               :
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/rand-0.3.16/src/isaac.rs"
 * 
 *     17 4.5e-04
 */
