               ...
               :           (C::is::<U1>() || C2::is::<U1>()) {
               :            unsafe {
     1 2.6e-05 :                let a = *self.get_unchecked(0, 0) * *rhs.get_unchecked(0, 0);
    32 8.5e-04 :                let b = *self.get_unchecked(1, 0) * *rhs.get_unchecked(1, 0);
    16 4.2e-04 :                let c = *self.get_unchecked(2, 0) * *rhs.get_unchecked(2, 0);
               :
               :                return a + b + c;
               :            }
               :        }
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/nalgebra-0.13.0/src/core/blas.rs"
 * 
 *     49  0.0013
 */
