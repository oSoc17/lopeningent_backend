               ...
               :    #[doc(hidden)]
               :    #[inline]
     1 2.6e-05 :    fn fmt_multi_header(&self, f: &mut MultilineFormatter) -> fmt::Result { /* hyper::header::HeaderFormat::fmt_multi_header::h8bf77709d00ced0f total:      1 2.6e-05 */
               ...
               :    fn write_str(&mut self, s: &str) -> fmt::Result { /* _$LT$hyper..header..NewlineReplacer$LT$$u27$a$C$$u20$$u27$b$GT$$u20$as$u20$core..fmt..Write$GT$::write_str::h0f2cbe41364846ba total:      1 2.6e-05 */
               :        let mut since = 0;
               :        for (i, &byte) in s.as_bytes().iter().enumerate() {
     1 2.6e-05 :            if byte == b'\r' || byte == b'\n' {
               ...
               :
               :    #[doc(hidden)]
               :    pub fn from_raw(raw: &[httparse::Header]) -> ::Result<Headers> { /* hyper::header::Headers::from_raw::h1bd376c9e6db9ca2 total:      1 2.6e-05 */
               :        let mut headers = Headers::new();
               :        for header in raw {
               ...
               :    pub fn get<H: Header + HeaderFormat>(&self) -> Option<&H> { /* hyper::header::Headers::get::h01a095bbe5fa4ec0 total:      1 2.6e-05 */
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/hyper-0.10.13/src/header/mod.rs"
 * 
 *      2 5.3e-05
 */
