               ...
               :    /// assert_eq!(b.len(), 5);
               :    /// ```
     8 2.1e-04 :    pub fn len(&self) -> usize { /* bytes::bytes::Bytes::len::h2e00cb89b768a02c total:     20 5.3e-04 */
               :        self.inner.len()
     7 1.8e-04 :    }
               :
               ...
               :    /// will panic.
    17 4.5e-04 :    pub fn slice(&self, begin: usize, end: usize) -> Bytes { /* bytes::bytes::Bytes::slice::hf0c587e8b44be20a total:    116  0.0031 */
               :        assert!(begin <= end);
               :        assert!(end <= self.len());
               :
    ...
    54  0.0014 :        ret
     ...
     8 2.1e-04 :    pub fn slice_from(&self, begin: usize) -> Bytes { /* bytes::bytes::Bytes::slice_from::ha9a35b43b4c62edf total:     20 5.3e-04 */
     3 7.9e-05 :        self.slice(begin, self.len())
     3 7.9e-05 :    }
               :
               ...
               :    ///
               :    /// Panics if `at > len`.
    17 4.5e-04 :    pub fn split_to(&mut self, at: usize) -> BytesMut { /* bytes::bytes::BytesMut::split_to::hb7765ebfe6ed1543 total:     26 6.9e-04 */
     6 1.6e-04 :        BytesMut {
               :            inner: Inner2 {
     1 2.6e-05 :                inner: self.inner.split_to(at),
               :            }
               :        }
     2 5.3e-05 :    }
               :
               ...
               :    pub fn reserve(&mut self, additional: usize) { /* bytes::bytes::BytesMut::reserve::h4f6d066b975dbb3f total:      3 7.9e-05 */
     ...
     1 2.6e-05 :    }
               ...
               :    fn as_ref(&self) -> &[u8] {
               :        unsafe {
    14 3.7e-04 :            if self.is_inline() {
               :                slice::from_raw_parts(self.inline_ptr(), self.inline_len())
               :            } else {
    26 6.9e-04 :                slice::from_raw_parts(self.ptr, self.len)
               :            }
               :        }
               :    }
               :
               ...
               :        } else {
     1 2.6e-05 :            slice::from_raw_parts_mut(self.ptr, self.cap)
               :        }
               :    }
               :
     ...
     6 1.6e-04 :        (p & INLINE_LEN_MASK) >> INLINE_LEN_OFFSET
               :    }
               :
               ...
               :    }
               :
    16 4.2e-04 :    fn split_to(&mut self, at: usize) -> Inner { /* bytes::bytes::Inner::split_to::hc9fb0ec4b939a9ce total:     94  0.0025 */
               :        let mut other = self.shallow_clone();
               :
               :        unsafe {
               :            other.set_end(at);
    ...
    46  0.0012 :        return other
     ...
     7 1.8e-04 :        if start == 0 {
               ...
               :
     6 1.6e-04 :            if self.len >= start {
               :                self.len -= start;
               :            } else {
     6 1.6e-04 :                self.len = 0;
               :            }
               :
    12 3.2e-04 :            self.cap -= start;
               :        }
               :    }
               :
               ...
               :            self.set_inline_len(new_len);
               :        } else {
     4 1.1e-04 :            assert!(end <= self.cap);
               :
               :            self.cap = end;
     1 2.6e-05 :            self.len = cmp::min(self.len, end);
               :        }
               :    }
               :
    ...
    58  0.0015 :    fn shallow_clone(&self) -> Inner { /* bytes::bytes::Inner::shallow_clone::h065fe9ac19fadfa4 total:    259  0.0068 */
               :        // Always check `inline` first, because if the handle is using inline
               :        // data storage, all of the `Inner` struct fields will be gibberish.
               :        if self.is_inline() {
     ...
     8 2.1e-04 :            if arc as usize & KIND_MASK == KIND_VEC {
               :                unsafe {
     ...
     1 2.6e-05 :                        original_capacity: arc as usize & !KIND_MASK,
     ...
     4 1.1e-04 :                        return Inner {
               ...
               :
   157  0.0041 :                if old_size == usize::MAX {
               :                    panic!(); // TODO: abort
               :                }
               :            }
               :
    ...
    34 9.0e-04 :        self.kind() == KIND_INLINE
               :    }
               :
    ...
    27 7.1e-04 :                (*p as usize) & KIND_MASK /* postgres_protocol::message::backend::Buffer::is_empty::ha5dd6a31dc567a9f total:      9 2.4e-04 */
               :            }
               :        }
               :
               :        #[cfg(target_endian = "big")]
     ...
     9 2.4e-04 :    fn drop(&mut self) { /* _$LT$bytes..bytes..Inner2$u20$as$u20$core..ops..Drop$GT$::drop::ha0bc36d4a01d56c5 total:    186  0.0049 */
               :        let kind = self.kind();
               :
    12 3.2e-04 :        if kind == KIND_VEC {
     ...
     5 1.3e-04 :    }
               ...
               :    unsafe {
   148  0.0039 :        if (*ptr).ref_count.fetch_sub(1, Release) != 1 {
               :            return;
               :        }
               :
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/bytes-0.4.5/src/bytes.rs"
 * 
 *    775  0.0205
 */
