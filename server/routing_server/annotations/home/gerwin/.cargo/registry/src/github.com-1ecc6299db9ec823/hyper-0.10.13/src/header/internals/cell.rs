               ...
               :
               :    #[inline]
               :    pub fn get(&self, key: TypeId) -> Option<&V> { /* _$LT$hyper..header..internals..cell..PtrMapCell$LT$V$GT$$GT$::get::hb8ef5ce4c851d914 total:      1 2.6e-05 */
     ...
     1 2.6e-05 :    }
               ...
               :
               :    #[inline]
               :    pub unsafe fn insert(&self, key: TypeId, val: Box<V>) { /* _$LT$hyper..header..internals..cell..PtrMapCell$LT$V$GT$$GT$::insert::hda6f1cf14e34e0c5 total:      2 5.3e-05 */
               :        let map = &mut *self.0.get();
               :        match *map {
     2 5.3e-05 :            PtrMap::Empty => *map = PtrMap::One(key, val),
               :            PtrMap::One(..) => {
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/hyper-0.10.13/src/header/internals/cell.rs"
 * 
 *      3 7.9e-05
 */
