               ...
               :    #[inline]
               :    fn read(&mut self, buf: &mut [u8]) -> io::Result<usize> { /* _$LT$hyper..net..HttpStream$u20$as$u20$std..io..Read$GT$::read::h2f70522d3c3de66e total:      1 2.6e-05 */
               :        self.0.read(buf)
     1 2.6e-05 :    }
               :}
               :
               ...
               :
               :    #[inline]
     1 2.6e-05 :    fn set_read_timeout(&self, dur: Option<Duration>) -> io::Result<()> { /* _$LT$hyper..net..HttpStream$u20$as$u20$hyper..net..NetworkStream$GT$::set_read_timeout::h847b6fafe259e279 total:      1 2.6e-05 */
               ...
               :
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/hyper-0.10.13/src/net.rs"
 * 
 *      2 5.3e-05
 */
