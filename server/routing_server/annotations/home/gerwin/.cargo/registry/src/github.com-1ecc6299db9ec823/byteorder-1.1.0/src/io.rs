               ...
               :        let mut buf = [0; 2];
     4 1.1e-04 :        try!(self.read_exact(&mut buf));
               :        Ok(T::read_u16(&buf))
               :    }
               :
     ...
     1 2.6e-05 :        Ok(T::read_f64(&buf))
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/byteorder-1.1.0/src/io.rs"
 * 
 *      8 2.1e-04
 */
