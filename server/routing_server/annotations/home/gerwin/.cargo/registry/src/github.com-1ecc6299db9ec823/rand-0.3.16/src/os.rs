               ...
               :
               :    fn getrandom_fill_bytes(v: &mut [u8]) { /* rand::os::imp::getrandom_fill_bytes::ha5362c27e60d3cbc total:      1 2.6e-05 */
               :        let mut read = 0;
               :        let len = v.len();
     1 2.6e-05 :        while read < len {
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/rand-0.3.16/src/os.rs"
 * 
 *      1 2.6e-05
 */
