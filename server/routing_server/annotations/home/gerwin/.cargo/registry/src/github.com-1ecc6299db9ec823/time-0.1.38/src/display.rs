               ...
               :}
               :
     1 2.6e-05 :fn parse_type(fmt: &mut fmt::Formatter, ch: char, tm: &Tm) -> fmt::Result { /* time::display::parse_type::h0c84204647201033 total:      3 7.9e-05 */
               :    match ch {
               ...
               :            _ => unreachable!(),
               :        }),
     1 2.6e-05 :        'a' => fmt.write_str(match tm.tm_wday {
               :            0 => "Sun",
               :            1 => "Mon",
               :            2 => "Tue",
               :            3 => "Wed",
               ...
               :        }
     1 2.6e-05 :        'w' => write!(fmt, "{}", tm.tm_wday),
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/time-0.1.38/src/display.rs"
 * 
 *      3 7.9e-05
 */
