               ...
               :    pub fn with_config(config: &Config, input: &[u8]) -> Self { /* serde_qs::de::QsDeserializer::with_config::h087049c7d6c5e52c total:      1 2.6e-05 */
               ...
               :        where V: de::Visitor<'de>,
               :    {
     1 2.6e-05 :        visitor.visit_map(self)
               :    }
               :
     ...
     1 2.6e-05 :                Level::Flat(x) => {
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_qs-0.2.1/src/de/mod.rs"
 * 
 *      2 5.3e-05
 */
