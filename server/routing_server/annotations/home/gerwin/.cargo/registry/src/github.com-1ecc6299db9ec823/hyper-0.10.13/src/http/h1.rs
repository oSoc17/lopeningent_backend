               ...
               :    fn flush(&mut self) -> io::Result<()> {
               :        match *self {
     1 2.6e-05 :            ThroughWriter(ref mut w) => w.flush(),
               ...
               :    loop {
     3 7.9e-05 :        match try!(try_parse::<R, T, I>(rdr)) {
               ...
               :
               :    fn try_parse<'b>(headers: &'b mut [httparse::Header<'b>], buf: &'b [u8]) -> /* _$LT$httparse..Request$LT$$u27$a$C$$u20$$u27$a$GT$$u20$as$u20$hyper..http..h1..TryParse$GT$::try_parse::hac16aeddbd33ffd2 total:      2 5.3e-05 */
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/hyper-0.10.13/src/http/h1.rs"
 * 
 *      4 1.1e-04
 */
