     ...
     1 2.6e-05 :    pub fn parse(self, input: &str) -> Result<Url, ::ParseError> { /* url::ParseOptions::parse::hc539ad8bf161275e total:      1 2.6e-05 */
               :        Parser {
               ...
               :    /// # run().unwrap();
               :    /// ```
               :    pub fn set_path(&mut self, mut path: &str) { /* url::Url::set_path::hbffb8fabc96ad2b9 total:      1 2.6e-05 */
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/url-1.5.1/src/lib.rs"
 * 
 *      1 2.6e-05
 */
