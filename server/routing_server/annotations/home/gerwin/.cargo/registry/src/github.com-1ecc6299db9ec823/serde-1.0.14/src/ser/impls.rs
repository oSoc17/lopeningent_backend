               ...
               :            #[inline]
     2 5.3e-05 :            fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> /* serde::ser::impls::_$LT$impl$u20$serde..ser..Serialize$u20$for$u20$f64$GT$::serialize::hccd06938d1809ead total:     48  0.0013 */
               :            where
               :                S: Serializer,
               :            {
               ...
               :            {
               :                #[inline]
     1 2.6e-05 :                fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error> /* serde::ser::impls::_$LT$impl$u20$serde..ser..Serialize$u20$for$u20$$LP$T0$C$$u20$T1$RP$$GT$::serialize::he35c2686a03ae882 total:      8 2.1e-04 */
               :                where
               :                    S: Serializer,
               :                {
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/serde-1.0.14/src/ser/impls.rs"
 * 
 *      3 7.9e-05
 */
