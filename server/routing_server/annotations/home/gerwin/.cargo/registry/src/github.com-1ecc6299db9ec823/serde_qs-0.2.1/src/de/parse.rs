     ...
     1 2.6e-05 :    fn default() -> Self { /* _$LT$serde_qs..de..parse..Config$u20$as$u20$core..default..Default$GT$::default::h31f83b380d3567ea total:      1 2.6e-05 */
               :        Config { max_depth: 5 }
               :    }
               :}
               :
               ...
               :
               :
     1 2.6e-05 :    fn parse(&mut self, node: &mut Level) -> Result<bool> { /* _$LT$serde_qs..de..parse..Parser$LT$I$GT$$GT$::parse::h8e3429e219e14ce3 total:      3 7.9e-05 */
     ...
     1 2.6e-05 :    }
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/serde_qs-0.2.1/src/de/parse.rs"
 * 
 *      4 1.1e-04
 */
