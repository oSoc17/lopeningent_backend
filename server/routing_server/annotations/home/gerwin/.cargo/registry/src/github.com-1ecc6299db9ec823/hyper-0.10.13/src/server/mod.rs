               ...
               :    }
               :
     1 2.6e-05 :    fn keep_alive_loop<W: Write>(&self, rdr: &mut BufReader<&mut NetworkStream>, /* _$LT$hyper..server..Worker$LT$H$GT$$GT$::keep_alive_loop::hb041d12e2a8ce217 total:      3 7.9e-05 */
               :            wrt: &mut W, addr: SocketAddr) -> bool {
               :        let req = match Request::new(rdr, addr) {
     1 2.6e-05 :            Ok(req) => req,
               ...
               :        }
               :
     1 2.6e-05 :        if let Err(e) = req.set_read_timeout(self.timeouts.read) {
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/hyper-0.10.13/src/server/mod.rs"
 * 
 *      3 7.9e-05
 */
