     ...
     2 5.3e-05 :    Ok(str::from_utf8(buf)?)
               :}
               :
     ...
     2 5.3e-05 :    let v = buf.read_f32::<BigEndian>()?;
               :    if !buf.is_empty() {
               :        return Err("invalid buffer size".into());
               :    }
               :    Ok(v)
     ...
     1 2.6e-05 :    for _ in 0..dimensions {
     ...
     3 7.9e-05 :        ArrayDimensions(&self.buf[..self.dimensions as usize * 8])
               :    }
               :
     ...
     1 2.6e-05 :        let val = if len < 0 {
               ...
               :    }
               :
     4 1.1e-04 :    fn size_hint(&self) -> (usize, Option<usize>) { /* _$LT$postgres_protocol..types..ArrayValues$LT$$u27$a$GT$$u20$as$u20$fallible_iterator..FallibleIterator$GT$::size_hint::he1469f61ad2a810b total:      8 2.1e-04 */
               :        let len = self.remaining as usize;
     2 5.3e-05 :        (len, Some(len))
     2 5.3e-05 :    }
               :}
               :
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/postgres-protocol-0.3.1/src/types.rs"
 * 
 *     29 7.7e-04
 */
