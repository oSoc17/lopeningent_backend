     ...
     2 5.3e-05 :            copy_nonoverlapping(
               ...
               :
     2 5.3e-05 :    if u & EXP_MASK == EXP_MASK && u & FRACT_MASK != 0 {
               ...
               :
     3 7.9e-05 :    if u & EXP_MASK == EXP_MASK && u & FRACT_MASK != 0 {
               :        // While IEEE 754-2008 specifies encodings for quiet NaNs and
               :        // signaling ones, certains MIPS and PA-RISC CPUs treat signaling
               :        // NaNs differently. Therefore, to be safe, we pass a known quiet
               :        // NaN if u is any kind of NaN. The check above only assumes
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/.cargo/registry/src/github.com-1ecc6299db9ec823/byteorder-1.1.0/src/lib.rs"
 * 
 *      7 1.8e-04
 */
