  ...
  4060  0.1072 :        self.element.next().map(|(&n, e)| (n, e))
               :    }
               :}
               :
               ...
               :}
/* 
 * Total samples for file : "/home/gerwin/Documents/projects/stujob/lopeningent_backend/server/routing_server/graph/src/graph/iter.rs"
 * 
 *   4060  0.1072
 */
